document.addEventListener("DOMContentLoaded", function () {
  ...
  collectionForm.addEventListener("submit", function (e) {
    ...
    // إزالة الفواصل من القيمة (إن وُجدت) لتحويلها بشكل صحيح

    let rawAmount = document.getElementById("collectionAmount").value;

    rawAmount = rawAmount.replace(/,/g, ""); // إزالة كل الفواصل
    ...
    document.querySelectorAll(".editCollection").forEach(btn => {
      ...
      btn.addEventListener("click", function () {
        ...
        if (item) {
          ...
          // إزالة السجل القديم ريثما يُحفظ مجدداً
  ...
  // عند بدء التشغيل: تحميل البيانات من التخزين، ثم عرضها
  ...
  // حفظ البيانات عند الخروج أو التحديث
    ...
    if (pageType === "collections") {
      ...
      html += `<table>
                ...
                <thead>
                  ...
                  <tr><th>المتحصلات</th><th>المصروفات</th><th>الصافي</th></tr>
